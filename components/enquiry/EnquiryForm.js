  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="form-group">
        ...
        <input
          {...register({required: true, maxLength: 30, validate: { firstLetterUpper }})}
          name="title"
          type="text"
      ...
      <div className="form-group">
        ...
        <input
          {...register({required: true, minLength: 5})}
          name="company"
          type="text"
          className="form-control"
          id="company"/>
      ...
      <div className="form-group">
        ...
        <input
          {...register({required: true, pattern: /^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/})}
          name="companyWebsite"
          type="text"
          className="form-control"
          id="companyWebsite"/>
